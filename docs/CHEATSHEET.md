...
| `npm run env:edit`                                                        | Ganti password / role / browser / OTP-CAPTCHA / company-tenant (multi-tenant)                                                                                                |
...
| `npm run health:check`                                                    | Cek MCP + env (sesi expired = warning, gate kode tetap hijau)                                                                                                                |
