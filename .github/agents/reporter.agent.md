...
Save to `artifacts/reports/pipeline-report-<runId>.md` (canonical; same resolver as `pipeline-state.json`):
...
| -------------------------- | ------------------ | ------- | --------- |
| SC-01: Valid login         | success            | user    | ✅ passed |
| SC-02: Invalid credentials | failure            | user    | 🔧 healed |
