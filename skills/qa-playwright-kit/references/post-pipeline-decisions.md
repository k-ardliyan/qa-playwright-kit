...
| ---------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------- |
| `artifacts/reports/html/index.html`            | ✅       | Open manually in a browser, or run `npm run dashboard`. Auto-open via `qa:run --open-dashboard` is opt-in (default OFF) |
...
If the dashboard does not open automatically: locate `artifacts/reports/html/index.html` and open it in a browser, or run `npm run dashboard`.
